...
> 玄一技术博客是一个致力于分享前端技术、开发经验和最新技术趋势的博客。我们提供高质量的教程、文章和案例分析，帮助开发者深入了解前端开发，并掌握最新的技术工具和框架。
...
```yml
# 首页 banner 图片
index_img: https://cdn.jsdelivr.net/gh/CuiBenyong/resources@main/ccblog_index_top.jpg
...
```sh
# 克隆仓库
$ git clone https://github.com/CuiBenyong/ccblog.git
# 安装依赖
$ yarn install
# 运行
$ yarn server
